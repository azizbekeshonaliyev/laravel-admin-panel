...
@section('title', __('labels.backend.access.topics.management') . ' | ' . __('labels.backend.access.topics.create'))
...
@section('content')
{{ Form::open(['route' => 'admin.topics.store', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'post', 'id' => 'create-permission', 'files' => true]) }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                                ...
                                @foreach(cache()->get('languages') as $language)
                                    <div class="tab-pane fade @if($loop->first) show active @endif" id="nav-name-{{$language->locale}}" role="tabpanel" aria-labelledby="nav-name-{{$language->locale}}-tab">
                                        <div class="form-group row">
                                            <label for="name_{{$language->locale}}" class="col-sm-2 col-form-label">@lang('validation.attributes.backend.access.topics.title')</label>
                                            <div class="col-md-10">
                                                <input name="translations[{{$language->locale}}][title]" id="name_{{$language->locale}}" type="text" class="form-control" placeholder="@lang('validation.attributes.backend.access.topics.title')">
                                            </div><!--col-->
                                        </div><!--form-group-->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <textarea name="translations[{{$language->locale}}][desc]" id="desc_{{$language->locale}}" rows="6" class="form-control tinyText" placeholder="@lang('validation.attributes.backend.access.topics.desc')"></textarea>
                                            </div><!--col-->
                                        </div><!--form-group-->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input name="translations[{{$language->locale}}][meta_title]" id="meta_title{{$language->locale}}" type="text" class="form-control" placeholder="@lang('validation.attributes.backend.access.topics.meta_title')">
                                            </div><!--col-->
                                        </div><!--form-group-->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <textarea name="translations[{{$language->locale}}][meta_description]" id="desc_{{$language->locale}}" rows="6" class="form-control" placeholder="@lang('validation.attributes.backend.access.topics.meta_description')"></textarea>
                                            </div><!--col-->
                                        </div><!--form-group-->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <textarea name="translations[{{$language->locale}}][meta_keywords]" id="desc_{{$language->locale}}" rows="6" class="form-control" placeholder="@lang('validation.attributes.backend.access.topics.meta_keywords')"></textarea>
                                            </div><!--col-->
                                        </div><!--form-group-->
                                    </div>
                                @endforeach
        ...
        @include('backend.components.footer-buttons', [ 'cancelRoute' => 'admin.topics.index' ])
    </div><!--card-->
    {{ Form::close() }}
@endsection
